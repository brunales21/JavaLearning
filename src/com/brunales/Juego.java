    ...
    public static void ahorcado() {
        ...
        do {
            ...
            do {
                ...
                System.out.println("Fallos: "+letrasFalladas.length()+" ["+letrasFalladas+"]");
                System.out.println(aux); //Muestra el progreso

            } while (hayChar(aux, '_') && letrasFalladas.length() <= nFallosPerm);
            if (letrasFalladas.length() > nFallosPerm) {
